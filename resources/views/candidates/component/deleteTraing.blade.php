<div class="modal animated zoomIn" id="deleteTrianing-modal">
...
<script>
   ...
   try {
    ...
    $("#deleteTrianing-modal").modal('show');
   } catch (error) {
    console.error(error);
   }
}
     ...
     async  function  deletebtnconfirm(){
         ...
         try {
            let id = document.getElementById('deleteID').value;
             ...
             showLoader();
             let res=await axios.post("/candidate/training/delete",{id:id},HeaderToken())
             hideLoader();
