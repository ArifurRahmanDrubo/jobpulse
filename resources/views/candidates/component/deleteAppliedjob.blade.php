<div class="modal animated zoomIn" id="deleteAppliedJob-modal">
...
<script>
   ...
   try {
    ...
    $("#eleteAppliedJob-modal").modal('show');
   } catch (error) {
    console.error(error);
   }
}
     ...
     async  function  deletebtnconfirm(){
         ...
         try {
            let id = document.getElementById('deleteID').value;
             ...
             showLoader();
             let res=await axios.post("/candidate/appliedjob/delete",{id:id},HeaderToken())
             hideLoader();
